...
def train(opt, init_mask, init_pattern):
    ...
    for epoch in range(opt.epoch):
        ...
        torch.save(inversion_engine.encoder.state_dict(), "unicorn_encoder.pt")
        torch.save(inversion_engine.decoder.state_dict(), "unicorn_decoder.pt")
        torch.save(inversion_engine.mask_tanh_input, "unicorn_input_mask.pt")
        torch.save(inversion_engine.pattern_tanh_input, "unicorn_input_pattern.pt")
        if (epoch+1)%1==0:
