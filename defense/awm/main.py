...
box = Box(opt)
device = box.device
classifier = ResNet18(num_classes=box.num_classes)
...
mask_optimizer = torch.optim.Adam(mask_params, lr = 1e-3)
...
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:1 --attack badnets --alpha 0.99 --num_classes 100
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:0 --attack blend --alpha 0.99 --num_classes 100
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:2 --attack ia --alpha 0.99 --num_classes 100
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:3 --attack wanet --alpha 0.99 --num_classes 100
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:0 --attack bppattack --alpha 0.99 --num_classes 100
# python defense/awm/main.py --dataset imagenet --tlabel 0 --device cuda:2 --attack lc --alpha 0.99 --num_classes 100