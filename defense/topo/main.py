...
import extract_fv_color_v2r
import extract_fv_color_v2xy 
import extract_fv_v17r
...
def demo_trojan_detector(model_filepath, result_filepath=None, scratch_dirpath=None, examples_dirpath=None, example_img_format='png'):
    ...
    fvs_color = extract_fv_color_v2r.extract_fv(model_filepath,examples_dirpath)
    fvs_color_xy = extract_fv_color_v2xy.extract_fv(model_filepath,examples_dirpath)
    fvs = extract_fv_v17r.extract_fv_v17r(model_filepath,examples_dirpath)
