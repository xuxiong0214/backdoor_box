...
print("load cln_testloader...")
cln_testloader = DataLoader(cln_testset, 32, shuffle=False, num_workers=6)
print("cln_testloader finished")
print("load bad_testloader...")
bad_testloader = DataLoader(bad_testset, 32, shuffle=False, num_workers=6)
print("bad_testloader finished")

model = resnet18(weights=ResNet18_Weights.DEFAULT)
state_dict_path = "../../checkpoints/imagenet1k-wanet-resnet18/state_dict.pt.tar"
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [50,75,100], 0.1)
