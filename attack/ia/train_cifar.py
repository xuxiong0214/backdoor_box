...
from models import densenet, vit
...
def eval(
    ...
    save_path = f"../../checkpoints/cifar-ia-vgg16-target{opt.target_label}/"
...
def train(opt):
    ...
    if opt.dataset == "cifar10":
        ...
        netC = VGG("VGG16", num_classes=10).to(opt.device)
        # netC = ResNet18(num_classes=10).to(opt.device)
        # netC = vit.ViT(
        #         image_size = 32,
        #         patch_size = 4,
        #         num_classes = 10,
