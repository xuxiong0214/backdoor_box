...
def eval(
    ...
    save_path = f"../../checkpoints/imagenet-ia-resnet18-target{opt.target_label}/"
...
def train(opt):
    ...
    state_dict = torch.load(os.path.join(root, "checkpoints/imagenet-ia-resnet18-target0/state_dict.pt.tar"), map_location=opt.device)
